                    ...
                    <div className="card-body form-group">
                      ...
                      <div className="row">
                        <div className="col-lg-6">
                          ...
                          <select name="companyid" id="companyid" className='form-control' value={product.companyid} onChange={(e) => { setProductData(e) }}>
                        ...
                        <div className="col-lg-6">
                          ...
                          <select name="pcid" id="pcid" className='form-control' value={product.pcid} onChange={(e) => { setProductData(e) }}>
